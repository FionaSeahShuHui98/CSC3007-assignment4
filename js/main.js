...
// console.log(d3.json("https://chi-loong.github.io/CSC3007/assignments/cases-sample.json"))
...
Promise.all([d3.json("https://chi-loong.github.io/CSC3007/assignments/links-sample.json"), d3.json("https://chi-loong.github.io/CSC3007/assignments/cases-sample.json")]).then(data => {
    ...
    let circle = nodes.append("circle")
        ...
        .attr("r", d => {
            if (d.bigcluster == true) return 20;
            else return 15
        })
        .attr("fill", d => {
        ...
        .on("mouseover", (event, d) => {
            ...
            tooltip.html("Age:" + d.age + ", Gender:" + d.gender + ", Vaccinated:" + d.vaccinated)
